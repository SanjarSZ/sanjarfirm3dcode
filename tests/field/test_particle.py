        ...
        for field_vac in [bsh, bri]:
            ...
            if isinstance(field_vac, BoozerRadialInterpolant):
                ...
                assert (
                    ...
                    and field.status_G
                    and field.status_iota
                    and field.modB_derivs
                )
                assert (
                    not field.status_I
                    and not field.status_dGds
                    and not field.status_dIds
                    and not field.status_K
                    and not field.status_K_derivs
                )
            else:
                field = field_vac
        ...
        for field_vac in [bsh, bri]:
            ...
            if isinstance(field_vac, BoozerRadialInterpolant):
                ...
                assert (
                    ...
                    and field.modB_derivs
                    and field.status_I
                    and field.status_dGds
                    and field.status_dIds
                )
        ...
        for solver_options in [
            ...
            gc_tys, gc_zeta_hits = trace_particles_boozer(
                ...
                stopping_criteria=[
                    ...
                    ToroidalTransitStoppingCriterion(1),
                ],
                tol=1e-10,
                **solver_options,
                axis=0,
        ...
        for solver_options in [
            ...
            gc_tys, gc_zeta_hits = trace_particles_boozer(
                ...
                stopping_criteria=[
                    ...
                    MaxToroidalFluxStoppingCriterion(0.6),
                ],
                tol=1e-10,
                **solver_options,
                forget_exact_path=False,
        ...
        for solver_options in [
            ...
            gc_tys, gc_zeta_hits = trace_particles_boozer(
                ...
                stopping_criteria=[
                    MinToroidalFluxStoppingCriterion(0.01),
                    MaxToroidalFluxStoppingCriterion(0.99),
                    ToroidalTransitStoppingCriterion(100),
                ],
                tol=1e-7,
                **solver_options,
            )
